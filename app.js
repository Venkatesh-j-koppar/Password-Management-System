...
var addNewCategoryRouter = require('./api/add-new-category');
var addProduct=require('./api/product');
...
app.use('/joinRouter', JoinRouter);
app.use('/api/add-category', addNewCategoryRouter);
